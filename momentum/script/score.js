// Score
console.log('Прошу обратить внимание, что музыка\nдовольно долго грузится при данном деплое');
console.log('Плеер работает: play/pause, prev/next,\nи треки воспроизводятся при нажатии на них');
...
console.log('[+] при изменении дня недели, даты, месяца эти данные меняются в приложении (в ходе кросс-чека этот пункт не проверяется)');
console.log('');
...
console.log('[+] плейлист генерируется средствами JavaScript (в ходе кросс-чека этот пункт не проверяется)');
console.log('');
